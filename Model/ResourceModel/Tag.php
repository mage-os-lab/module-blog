...
class Tag extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    protected function _beforeDelete(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $this->getConnection()->delete($this->getTable('blog_post_tag'), $condition);
    ...
    protected function _afterSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $this->_updateLinks($object, $newIds, $oldIds, 'blog_tag_store', 'store_id');
    ...
    protected function _getLoadByIdentifierSelect($identifier, $storeIds)
    {
        $select = $this->getConnection()->select()->from(
            ...
            ['cps' => $this->getTable('blog_tag_store')],
    ...
    {
        return $this->_lookupIds($tagId, 'blog_tag_store', 'store_id');
    }
