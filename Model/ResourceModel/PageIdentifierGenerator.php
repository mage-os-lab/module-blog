...
class PageIdentifierGenerator
{
    ...
    public function generate(\Magento\Framework\DataObject $object)
    {
        ...
        while (true) {
            ...
            $postId = $post->checkIdentifier($finalIdentifier, (int)$object->getStoreId());
            $categoryId = $category->checkIdentifier($finalIdentifier, (int)$object->getStoreId());
            ...
            if (!$postId && !$categoryId) {
                ...
                if ($postId
                    && $postId == $object->getId()
                    && $object instanceof \MageOS\Blog\Model\Post
                ) {
                    break;
                }
                ...
                if ($categoryId
                    ...
                    && $object instanceof \MageOS\Blog\Model\Category
                ) {
                    break;
                }
            }
