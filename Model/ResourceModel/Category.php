...
class Category extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    protected function _beforeDelete(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $this->getConnection()->delete($this->getTable('blog_category_store'), $condition);
        $this->getConnection()->delete($this->getTable('blog_post_category'), $condition);
    ...
    protected function _afterSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $table = $this->getTable('blog_category_store');
    ...
    protected function _getLoadByIdentifierSelect($identifier, $storeIds)
    {
        $select = $this->getConnection()->select()->from(
            ...
            ['cps' => $this->getTable('blog_category_store')],
     ...
     * @return string
     */
    public function checkIdentifier($identifier, $storeIds): string
    {
    ...
    public function lookupStoreIds($categoryId, $useCache = true)
    {
        if (null === self::$allStoreIds || !$useCache) {
            ...
            $select = $adapter->select()->from(
                $this->getTable('blog_category_store')
            );
