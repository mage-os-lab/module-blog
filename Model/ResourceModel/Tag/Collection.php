...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        parent::_construct();
        $this->_init(\MageOS\Blog\Model\Tag::class, \MageOS\Blog\Model\ResourceModel\Tag::class);
    ...
    {
        return $this
            ->addFieldToFilter('main_table.is_active', \MageOS\Blog\Model\Tag::STATUS_ENABLED);
    }
    /**
    ...
    protected function _afterLoad()
    {
        ...
        if (count($items)) {
            ...
            $tableName = $this->getTable('blog_tag_store');
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                ['store_table' => $this->getTable('blog_tag_store')],
