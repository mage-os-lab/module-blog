...
class Post extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    protected function _beforeDelete(
        ...
        foreach ($tableSufixs as $sufix) {
            $this->getConnection()->delete(
                $this->getTable('blog_post_' . $sufix),
                ($sufix == 'relatedpost')
    ...
    protected function _beforeSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $identifierGenerator = \Magento\Framework\App\ObjectManager::getInstance()
                ->create(\MageOS\Blog\Model\ResourceModel\PageIdentifierGenerator::class);
    ...
    protected function _afterSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $this->_updateLinks($object, $newIds, $oldIds, 'blog_post_store', 'store_id');
    ...
    {
        return $this->_lookupIds($postId, 'blog_post_store', 'store_id');
    }
    ...
    {
        return $this->_lookupIds($postId, 'blog_post_category', 'category_id');
    }
    ...
    {
        return $this->_lookupIds($postId, 'blog_post_tag', 'tag_id');
    }
    ...
    {
        return $this->_lookupIds($postId, 'blog_post_relatedpost', 'related_id');
    }
    ...
    {
        return $this->_lookupIds($postId, 'blog_post_relatedproduct', 'related_id');
    }
