...
abstract class AbstractImport extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @param \MageOS\Blog\Model\TagFactory $tagFactory
    ...
    {
        $mediaPath = $this->fileSystem->getDirectoryRead(\Magento\Framework\App\Filesystem\DirectoryList::MEDIA)->getAbsolutePath() . '/mageos_blog';
