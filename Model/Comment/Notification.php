...
namespace MageOS\Blog\Model\Comment;
...
class Notification
{
     ...
     * @param \MageOS\Blog\Model\ResourceModel\Comment\CollectionFactory  $commentCollectionFactory
     */
    ...
    public function checkComments()
    {
        ...
        $pendignComment = $this->commentCollectionFactory->create()
            ->addFieldToFilter('status', \MageOS\Blog\Model\Config\Source\CommentStatus::PENDING)
            ->setPageSize(1)
            ->getFirstItem();
