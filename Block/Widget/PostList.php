<?php
/**
 * Copyright © 2015 Ihor Vansach (ihor@mageos.com). All rights reserved.
 ...
 */
class PostList extends \MageOS\Blog\Block\Post\PostList\AbstractList implements \Magento\Widget\Block\BlockInterface
{
    /**
     * Block template file
     * @var string
     */
    protected $_defaultToolbarBlock = 'MageOS\Blog\Block\Post\PostList\Toolbar';
    ...
    public function getPostCollection(): \MageOS\Blog\Model\ResourceModel\Post\Collection
    {
    ...
    public function getTemplate(): string
    {
        if ($this->isFullHtml()) {
            ...
            return 'MageOS_Blog::post/widget/ajax-blog.phtml';
        }
    }
