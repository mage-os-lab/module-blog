...
namespace MageOS\Blog\Block\Adminhtml\Widget\Featured\Grid;
...
{
    private SecureHtmlRenderer $customSecureRenderer;

    public function __construct(
        Context $context,
        EncoderInterface $jsonEncoder,
        Factory $elementFactory,
        SecureHtmlRenderer $customSecureRenderer,
        array $data = []
    ) {
        parent::__construct($context, $jsonEncoder, $elementFactory, $data);
        $this->customSecureRenderer = $customSecureRenderer;
    }
    ...
    protected function _toHtml() : string
    {
        ...
        $script = 'function keyupFunctionMf() {
            ...
            ';
        $html .= $this->customSecureRenderer->renderTag('script', [], $script, false);
