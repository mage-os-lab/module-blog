...
namespace MageOS\Blog\Block\Adminhtml\Widget\Featured;
...
/**
 * @TODO refactor class to use new implementation of Extended
 */
class Grid extends Extended
{
    protected PostCollectionFactory $postCollectionFactory;
    protected WidgetCollectionFactory $widgetCollectionFactory;
    ...
    public function prepareElementHtml(AbstractElement $element) : AbstractElement
    {
        ...
        $chooser = $this->getLayout()->createBlock(
            \MageOS\Blog\Block\Adminhtml\Widget\Featured\Grid\Chooser::class
        )->setElement(
            $element
        )->setConfig(
            $this->getConfig()
